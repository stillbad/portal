...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTExNTkxMDk2MThkZMd2DH2fVw4fa9z0HbCpL4vwMfx6" />


<script type="text/javascript">
//<![CDATA[
var objJSONObject = { 'LogoLink':'LogoLink','ctl04':'ctl04','divHome':'divHome','ctl05':'ctl05','ltWebServerName':'ltWebServerName' }//]]>
</script>
     ...
     <div>
        ...
        <div id="controls-wrapper" class="load-item">
            <div class="centered-controls">
                ...
                <h4>&copy; 2001-2020 Illuminate Education, Inc.  All rights reserved. </h4></div>
